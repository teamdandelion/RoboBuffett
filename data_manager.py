...
class company:
	def __init__(self, document):
		company.CIK = document.CIK
		company.SIC = document.SIC
		company.documents = [(document.date, document)]
		company.name = document.cname

	def add_document(self, document):
		company.documents.append((document.date, document))
			...
			if isInt: 
				try:
					...
					try: 
						...
						logging.error('Unable to force-convert line to get int value.')
			if propertyname != '':
...
if __name__ == "__main__":
	...
	print "Statistics: %d documents, %d companies %d words" % (universe.doc_count, universe.co_count, universe.word_count)
	logging.info("Statistics: %d documents, %d companies %d words" % (universe.doc_count, universe.co_count, universe.word_count))
	f = open('./universe.dat', 'w')
